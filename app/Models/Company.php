 ...
 */
#[Fillable(['name', 'website', 'email', 'contact_name', 'city', 'kvk_number', 'industry', 'status', 'notes', 'source', 'contact_role', 'linkedin_url', 'lead_score', 'first_contact_channel', 'language'])]
class Company extends Model
{
    ...
    /**
     * Mirrors the column defaults so a newly created model carries them in
     * memory too: Eloquent does not read them back after an insert, and a null
     * language reaches the letter templates as a missing key.
     *
